...
namespace Michsky.UI.Shift
{
    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            showParticle = EditorGUILayout.Foldout(showParticle, "Particles", true, foldoutStyle);
            ...
            if (editorHints.boolValue == true)
            {
                ...
                EditorGUILayout.HelpBox("Remove 'UI Manager' component from the object to change variables manually.", MessageType.Info);
        ...
        void ResetToDefaults()
        {
            if (EditorUtility.DisplayDialog("Reset to defaults", "Are you sure you want to reset UI Manager values to default?", "Yes", "Cancel"))
            {
                ...
                {
                    Debug.LogWarning("<b>[Shift UI Manager]</b> Resetting is failed.");
                }
            }
        }
    }
